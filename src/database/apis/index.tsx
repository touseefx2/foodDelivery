const BASE_URL = 'http://ec2-3-109-121-63.ap-south-1.compute.amazonaws.com/';
// const BASE_URL = 'http://192.168.0.112:3001/';

//apis
const GET_CITIES_AREAS = 'api/area/getAllAreas';
const GET_SLIDER_IMAGES = 'api/branch/setting/area/';
const GET_FOOD_CATEGORY = 'api/branch/avaliablebranchmenu/products/';
