            ...
            ? {
                loc: {
                  ...
                  address: functions.capitalizeTheFirstLetterOfEachWord(
                    branchSetting?.address?.trim(),
                  ),
                },
                opening_times: branchSetting.opening_times || openTimes,
                deliveryType: deliveryList,
                estimatedDeliveryTime: branchSetting.estimatedDeliveryTime,
                estimatedPickupTime: branchSetting.estimatedPickupTime,
                deliveryCharges: branchSetting.deliveryCharges,
                tax: branchSetting.tax,
              }
            : null,
          appName: functions.capitalizeTheFirstLetterOfEachWord(
            generalSetting?.appName?.trim(),
          ),
